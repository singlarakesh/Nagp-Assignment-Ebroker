...
//				.andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.hasSize(1)));
		...
		// put
//		mockMvc.perform(MockMvcRequestBuilders.put("/trader/addFunds/2/200"))
//				.andExpect(MockMvcResultMatchers.status().isOk());
		
//		mockMvc.perform(MockMvcRequestBuilders.put("/trader/buyEquity/1/2"))
//		.andExpect(MockMvcResultMatchers.status().isOk());
		
//		mockMvc.perform(MockMvcRequestBuilders.put("/trader/sellEquity/1/2"))
//		.andExpect(MockMvcResultMatchers.status().isOk());
	}
